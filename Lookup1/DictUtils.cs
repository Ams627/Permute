    ...
    internal class DictUtils
        {
            ...
            /// <param name="key">Dictionary key of the List to add to</param>
            /// <param name="listEntry">Value to add to the List</param>
            public static void AddEntryToList<T1, T2>(Dictionary<T1, SortedSet<T2>> d, T1 key, T2 setEntry)
            {
                if (!d.TryGetValue(key, out var list))
                {
            ...
            ///// <param name="key">Dictionary key of the List to add to</param>
            ///// <param name="listEntry">Value to add to the List</param>
            //public static void AddEntryToList<T1, T2>(SortedDictionary<T1, SortedSet<T2>> d, T1 key, T2 setEntry)
            //{
            //    if (!d.TryGetValue(key, out var list))
            //    {
            //        list = new SortedSet<T2>();
